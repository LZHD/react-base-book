...
对于第一个问题，我们在 [高阶组件](https://lzhd.github.io/react-base-book/#/2017-03-11-lesson28) 的章节说过，可以把一些可复用的逻辑放在高阶组件当中，高阶组件包装的新组件和原来组件之间通过 `props` 传递信息，减少代码的重复程度。
...
<a href="_images/ED7B72E6-73BE-429F-AE3C-F9C15C3BE35E.png" target="_blank">![实例图片](_images/ED7B72E6-73BE-429F-AE3C-F9C15C3BE35E.png)</a>
